...
class RecommendedProduct(object):
    ...
    def __init__(self, digi_key_product_number=None, manufacturer_product_number=None, manufacturer_name=None, primary_photo=None, product_description=None, quantity_available=None, unit_price=None, product_url=None, other_names=None):  # noqa: E501
    ...
    def other_names(self):
        """Gets the other_names of this RecommendedProduct.  # noqa: E501

        Other Names may include former part numbers (changed through manufacturer acquisition), cross references for parts we don't carry, among other reasons.  # noqa: E501

        :return: The other_names of this RecommendedProduct.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def other_names(self, other_names):
        """Sets the other_names of this RecommendedProduct.

        Other Names may include former part numbers (changed through manufacturer acquisition), cross references for parts we don't carry, among other reasons.  # noqa: E501

        :param other_names: The other_names of this RecommendedProduct.  # noqa: E501
        :type: list[str]
        """
