...
class FilterOptionsRequest(object):
    ...
    def __init__(self, manufacturer_filter=None, category_filter=None, status_filter=None, packaging_filter=None, market_place_filter=None, tariff_filter=None, series_filter=None, minimum_quantity_available=None, parameter_filter_request=None, search_options=None):  # noqa: E501
        ...
        if tariff_filter is not None:
            self.tariff_filter = tariff_filter
    ...
    def tariff_filter(self):
        """Gets the tariff_filter of this FilterOptionsRequest.  # noqa: E501

        TariffFilter  # noqa: E501

        :return: The tariff_filter of this FilterOptionsRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def tariff_filter(self, tariff_filter):
        """Sets the tariff_filter of this FilterOptionsRequest.

        TariffFilter  # noqa: E501

        :param tariff_filter: The tariff_filter of this FilterOptionsRequest.  # noqa: E501
        :type: str
        """
        allowed_values = ["None", "ExcludeTariff", "TariffOnly"]  # noqa: E501
        if tariff_filter not in allowed_values:
            raise ValueError(
                "Invalid value for `tariff_filter` ({0}), must be one of {1}"  # noqa: E501
                .format(tariff_filter, allowed_values)
            )
